...
case $(uname) in
	...
	(Darwin)
		...
		path=(/Applications/MacVim.app/Contents/MacOS(N) ~/.config/yarn/global/node_modules/.bin(N) ~/.yarn-config/global/node_modules/.bin(N) /usr/local/bin /usr/bin /bin /usr/sbin /sbin)
